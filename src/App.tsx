...
import { signIn, logOut, db, auth, handleFirestoreError, OperationType, signInWithCustomToken } from './firebase';
...
function AppContent() {
  ...
  const [loginMode, setLoginMode] = useState<'google' | 'custom' | 'register'>('google');
          ...
          <Card className="p-8 text-center flex flex-col gap-6 shadow-xl border-t-4 border-t-blue-600">
            ...
            <div className="flex p-1 bg-gray-100 rounded-lg">
              <button
                ...
                className={cn(
                  ...
                  loginMode === 'google' ? "bg-white text-blue-600 shadow-sm" : "text-gray-500 hover:text-gray-700"
                )}
              >
                Google Login
              </button>
            ...
            {loginMode === 'google' ? (
              <div className="space-y-4">
                <Button onClick={signIn} className="w-full h-12 text-lg flex items-center justify-center gap-2 group">
                ...
                <p className="text-xs text-gray-400">Acesso seguro via conta Google institucional.</p>
              </div>
